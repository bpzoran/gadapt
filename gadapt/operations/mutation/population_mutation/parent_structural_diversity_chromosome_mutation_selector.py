...
class ParentStructuralDiversityChromosomeMutationSelector(ParentDiversityChromosomeMutationSelector):
    """
    ...
    def _get_diversity_coefficient(self, chromosome):
        ...
        return chromosome.parent_structural_diversity_coefficient

    def _sort_key_parent_diversity(self, c: Chromosome):
        return c.parent_structural_diversity_coefficient, random.random()
